...
INSERT INTO chat_messages (sender_id, receiver_group_id, message)
VALUES (2, 1, 'Hello everyone, welcome to the group!');  -- Group ID should be referenced

-- Create example for sending file (individual)
INSERT INTO files (sender_id, receiver_id, file_name, file_url, file_type, file_size)
...
INSERT INTO files (sender_id, receiver_group_id, file_name, file_url, file_type, file_size)
